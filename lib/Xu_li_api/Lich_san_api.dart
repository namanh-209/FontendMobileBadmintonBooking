...
class LichSanApi {
  static final GoiApi _api = GoiApi();
  ...
  static Future<List<dynamic>> layLichSan(
    ...
    final data = await _api.getAny([
      ...
      ngay == null ? '/lich-san/$sanId' : '/lich-san/$sanId?ngay=$ngay',
      ngay == null ? '/san/$sanId/lich' : '/san/$sanId/lich?ngay=$ngay',
    ]);
  ...
  static Future<List<dynamic>> layLichCoSo(
    ...
    final data = await _api.getAny([
      ...
      ngay == null ? '/dat-san/lich?co_so_id=$coSoId' : '/dat-san/lich?co_so_id=$coSoId&ngay=$ngay',
      ngay == null ? '/co_so/$coSoId/lich' : '/co_so/$coSoId/lich?ngay=$ngay',
      ngay == null ? '/coso/$coSoId/lich' : '/coso/$coSoId/lich?ngay=$ngay',
    ]);
